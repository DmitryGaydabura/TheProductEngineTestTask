...
HX_DEFINE_STACK_FRAME(_hx_pos_7a59ac6f685f8a04_75_new,"haxe.xml.XmlParserException","new",0xcd6fdfea,"haxe.xml.XmlParserException.new","F:\\program1\\haxe\\std/haxe/xml/Parser.hx",75,0x55d4e259)
HX_LOCAL_STACK_FRAME(_hx_pos_7a59ac6f685f8a04_95_toString,"haxe.xml.XmlParserException","toString",0xed7c2ce2,"haxe.xml.XmlParserException.toString","F:\\program1\\haxe\\std/haxe/xml/Parser.hx",95,0x55d4e259)
namespace haxe{
namespace xml{

void XmlParserException_obj::__construct(::String message,::String xml,int position){
            	HX_STACKFRAME(&_hx_pos_7a59ac6f685f8a04_75_new)
...
::String XmlParserException_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_7a59ac6f685f8a04_95_toString)
