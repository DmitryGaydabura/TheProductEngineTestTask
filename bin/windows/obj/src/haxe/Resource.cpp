...
HX_LOCAL_STACK_FRAME(_hx_pos_e48e4be67d1691fe_35_getBytes,"haxe.Resource","getBytes",0x9bc1712d,"haxe.Resource.getBytes","F:\\program1\\haxe\\std/cpp/_std/haxe/Resource.hx",35,0x41b7788b)
namespace haxe{
...
bool Resource_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Bytes Resource_obj::getBytes(::String name){
            	HX_STACKFRAME(&_hx_pos_e48e4be67d1691fe_35_getBytes)
