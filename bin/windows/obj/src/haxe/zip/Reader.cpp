...
HX_DEFINE_STACK_FRAME(_hx_pos_ad5048a6e614c01c_33_new,"haxe.zip.Reader","new",0xf101338a,"haxe.zip.Reader.new","F:\\program1\\haxe\\std/haxe/zip/Reader.hx",33,0xa63721ff)
HX_LOCAL_STACK_FRAME(_hx_pos_ad5048a6e614c01c_36_readZipDate,"haxe.zip.Reader","readZipDate",0xa6a02623,"haxe.zip.Reader.readZipDate","F:\\program1\\haxe\\std/haxe/zip/Reader.hx",36,0xa63721ff)
HX_LOCAL_STACK_FRAME(_hx_pos_ad5048a6e614c01c_48_readExtraFields,"haxe.zip.Reader","readExtraFields",0x48ea639d,"haxe.zip.Reader.readExtraFields","F:\\program1\\haxe\\std/haxe/zip/Reader.hx",48,0xa63721ff)
HX_LOCAL_STACK_FRAME(_hx_pos_ad5048a6e614c01c_78_readEntryHeader,"haxe.zip.Reader","readEntryHeader",0x28765213,"haxe.zip.Reader.readEntryHeader","F:\\program1\\haxe\\std/haxe/zip/Reader.hx",78,0xa63721ff)
HX_LOCAL_STACK_FRAME(_hx_pos_ad5048a6e614c01c_121_read,"haxe.zip.Reader","read",0xf2b0acec,"haxe.zip.Reader.read","F:\\program1\\haxe\\std/haxe/zip/Reader.hx",121,0xa63721ff)
HX_LOCAL_STACK_FRAME(_hx_pos_ad5048a6e614c01c_194_readZip,"haxe.zip.Reader","readZip",0x2845d555,"haxe.zip.Reader.readZip","F:\\program1\\haxe\\std/haxe/zip/Reader.hx",194,0xa63721ff)
namespace haxe{
namespace zip{

void Reader_obj::__construct( ::haxe::io::Input i){
            	HX_STACKFRAME(&_hx_pos_ad5048a6e614c01c_33_new)
HXDLIN(  33)		this->i = i;
            	}
...
bool Reader_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Date Reader_obj::readZipDate(){
            	HX_GC_STACKFRAME(&_hx_pos_ad5048a6e614c01c_36_readZipDate)
...
HX_DEFINE_DYNAMIC_FUNC0(Reader_obj,readZipDate,return )
 ...
 ::haxe::ds::List Reader_obj::readExtraFields(int length){
            	HX_GC_STACKFRAME(&_hx_pos_ad5048a6e614c01c_48_readExtraFields)
...
HX_DEFINE_DYNAMIC_FUNC1(Reader_obj,readExtraFields,return )
 ...
 ::Dynamic Reader_obj::readEntryHeader(){
            	HX_STACKFRAME(&_hx_pos_ad5048a6e614c01c_78_readEntryHeader)
...
HX_DEFINE_DYNAMIC_FUNC0(Reader_obj,readEntryHeader,return )
 ...
 ::haxe::ds::List Reader_obj::read(){
            	HX_GC_STACKFRAME(&_hx_pos_ad5048a6e614c01c_121_read)
...
HX_DEFINE_DYNAMIC_FUNC0(Reader_obj,read,return )
 ...
 ::haxe::ds::List Reader_obj::readZip( ::haxe::io::Input i){
            	HX_GC_STACKFRAME(&_hx_pos_ad5048a6e614c01c_194_readZip)
