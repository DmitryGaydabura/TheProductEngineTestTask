...
HX_DEFINE_STACK_FRAME(_hx_pos_95d6239a4ddd868c_28_new,"haxe.iterators.ArrayIterator","new",0x70a754c8,"haxe.iterators.ArrayIterator.new","F:\\program1\\haxe\\std/haxe/iterators/ArrayIterator.hx",28,0x99da3a6f)
HX_LOCAL_STACK_FRAME(_hx_pos_95d6239a4ddd868c_45_hasNext,"haxe.iterators.ArrayIterator","hasNext",0x74587dd5,"haxe.iterators.ArrayIterator.hasNext","F:\\program1\\haxe\\std/haxe/iterators/ArrayIterator.hx",45,0x99da3a6f)
HX_LOCAL_STACK_FRAME(_hx_pos_95d6239a4ddd868c_53_next,"haxe.iterators.ArrayIterator","next",0x21c2db8b,"haxe.iterators.ArrayIterator.next","F:\\program1\\haxe\\std/haxe/iterators/ArrayIterator.hx",53,0x99da3a6f)
namespace haxe{
namespace iterators{

void ArrayIterator_obj::__construct(::cpp::VirtualArray array){
            	HX_STACKFRAME(&_hx_pos_95d6239a4ddd868c_28_new)
...
bool ArrayIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_95d6239a4ddd868c_45_hasNext)
...
HX_DEFINE_DYNAMIC_FUNC0(ArrayIterator_obj,hasNext,return )
 ...
 ::Dynamic ArrayIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_95d6239a4ddd868c_53_next)
