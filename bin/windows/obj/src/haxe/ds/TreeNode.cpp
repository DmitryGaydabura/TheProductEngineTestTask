...
HX_DEFINE_STACK_FRAME(_hx_pos_d8c2a2214ce2d142_252_new,"haxe.ds.TreeNode","new",0x88d32f89,"haxe.ds.TreeNode.new","F:\\program1\\haxe\\std/haxe/ds/BalancedTree.hx",252,0x2a299d66)
namespace haxe{
namespace ds{
...
void TreeNode_obj::__construct( ::haxe::ds::TreeNode l, ::Dynamic k, ::Dynamic v, ::haxe::ds::TreeNode r,::hx::Null< int >  __o_h){
            	...
            	HX_STACKFRAME(&_hx_pos_d8c2a2214ce2d142_252_new)
