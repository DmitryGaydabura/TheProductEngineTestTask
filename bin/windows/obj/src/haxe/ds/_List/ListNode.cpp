...
HX_DEFINE_STACK_FRAME(_hx_pos_fa2897f4947aa926_266_new,"haxe.ds._List.ListNode","new",0x5847787a,"haxe.ds._List.ListNode.new","F:\\program1\\haxe\\std/haxe/ds/List.hx",266,0x342b474e)
namespace haxe{
namespace ds{
namespace _List{

void ListNode_obj::__construct( ::Dynamic item, ::haxe::ds::_List::ListNode next){
            	HX_STACKFRAME(&_hx_pos_fa2897f4947aa926_266_new)
