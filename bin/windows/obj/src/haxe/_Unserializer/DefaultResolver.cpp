...
HX_DEFINE_STACK_FRAME(_hx_pos_49df20cadcd19ed7_512_new,"haxe._Unserializer.DefaultResolver","new",0xe2809ead,"haxe._Unserializer.DefaultResolver.new","F:\\program1\\haxe\\std/haxe/Unserializer.hx",512,0x6193d685)
HX_LOCAL_STACK_FRAME(_hx_pos_49df20cadcd19ed7_515_resolveClass,"haxe._Unserializer.DefaultResolver","resolveClass",0xbc0d3dbf,"haxe._Unserializer.DefaultResolver.resolveClass","F:\\program1\\haxe\\std/haxe/Unserializer.hx",515,0x6193d685)
HX_LOCAL_STACK_FRAME(_hx_pos_49df20cadcd19ed7_518_resolveEnum,"haxe._Unserializer.DefaultResolver","resolveEnum",0x8198f35a,"haxe._Unserializer.DefaultResolver.resolveEnum","F:\\program1\\haxe\\std/haxe/Unserializer.hx",518,0x6193d685)
namespace haxe{
namespace _Unserializer{

void DefaultResolver_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_49df20cadcd19ed7_512_new)
            	}
...
::hx::Class DefaultResolver_obj::resolveClass(::String name){
            	HX_STACKFRAME(&_hx_pos_49df20cadcd19ed7_515_resolveClass)
...
::hx::Class DefaultResolver_obj::resolveEnum(::String name){
            	HX_STACKFRAME(&_hx_pos_49df20cadcd19ed7_518_resolveEnum)
