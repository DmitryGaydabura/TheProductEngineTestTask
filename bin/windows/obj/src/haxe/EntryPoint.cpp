...
HX_LOCAL_STACK_FRAME(_hx_pos_bf1fe7a41d4be130_126_run,"haxe.EntryPoint","run",0xf0324cc3,"haxe.EntryPoint.run","F:\\program1\\haxe\\std/haxe/EntryPoint.hx",126,0xbc97eb92)
namespace haxe{
...
void EntryPoint_obj::run(){
            	HX_STACKFRAME(&_hx_pos_bf1fe7a41d4be130_126_run)
            	}
