...
HX_DEFINE_STACK_FRAME(_hx_pos_23a3da8d56a8cd16_8_new,"haxe.exceptions.NotImplementedException","new",0xcfd1d5d0,"haxe.exceptions.NotImplementedException.new","F:\\program1\\haxe\\std/haxe/exceptions/NotImplementedException.hx",8,0xf411cddb)
namespace haxe{
...
void NotImplementedException_obj::__construct(::String __o_message, ::haxe::Exception previous, ::Dynamic pos){
            	...
            	HX_STACKFRAME(&_hx_pos_23a3da8d56a8cd16_8_new)
