...
HX_LOCAL_STACK_FRAME(_hx_pos_66b442c11a5854ff_51_read,"sys.io.File","read",0x203d07e1,"sys.io.File.read","F:\\program1\\haxe\\std/cpp/_std/sys/io/File.hx",51,0x6e908bdf)
namespace sys{
namespace io{
...
bool File_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::sys::io::FileInput File_obj::read(::String path,::hx::Null< bool >  __o_binary){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_66b442c11a5854ff_51_read)
