...
HX_DEFINE_STACK_FRAME(_hx_pos_fce8eb153b1c5cb6_278_new,"sys.thread._EventLoop.RegularEvent","new",0x9d3b475c,"sys.thread._EventLoop.RegularEvent.new","F:\\program1\\haxe\\std/sys/thread/EventLoop.hx",278,0xface6ce8)
namespace sys{
namespace thread{
namespace _EventLoop{

void RegularEvent_obj::__construct( ::Dynamic run,Float nextRunTime,Float interval){
            	HX_STACKFRAME(&_hx_pos_fce8eb153b1c5cb6_278_new)
