...
HX_DEFINE_STACK_FRAME(_hx_pos_efbf80bd564e5e4b_30_new,"sys.thread.Deque","new",0xfb067acf,"sys.thread.Deque.new","F:\\program1\\haxe\\std/cpp/_std/sys/thread/Deque.hx",30,0x9179137d)
HX_LOCAL_STACK_FRAME(_hx_pos_efbf80bd564e5e4b_34_add,"sys.thread.Deque","add",0xfafc9c90,"sys.thread.Deque.add","F:\\program1\\haxe\\std/cpp/_std/sys/thread/Deque.hx",34,0x9179137d)
HX_LOCAL_STACK_FRAME(_hx_pos_efbf80bd564e5e4b_38_push,"sys.thread.Deque","push",0xac03888b,"sys.thread.Deque.push","F:\\program1\\haxe\\std/cpp/_std/sys/thread/Deque.hx",38,0x9179137d)
HX_LOCAL_STACK_FRAME(_hx_pos_efbf80bd564e5e4b_42_pop,"sys.thread.Deque","pop",0xfb080800,"sys.thread.Deque.pop","F:\\program1\\haxe\\std/cpp/_std/sys/thread/Deque.hx",42,0x9179137d)
namespace sys{
namespace thread{

void Deque_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_efbf80bd564e5e4b_30_new)
...
void Deque_obj::add( ::Dynamic i){
            	HX_STACKFRAME(&_hx_pos_efbf80bd564e5e4b_34_add)
...
void Deque_obj::push( ::Dynamic i){
            	HX_STACKFRAME(&_hx_pos_efbf80bd564e5e4b_38_push)
...
HX_DEFINE_DYNAMIC_FUNC1(Deque_obj,push,(void))
 ...
 ::Dynamic Deque_obj::pop(bool block){
            	HX_STACKFRAME(&_hx_pos_efbf80bd564e5e4b_42_pop)
