...
HX_DEFINE_STACK_FRAME(_hx_pos_9efbd1ecb0664138_24_new,"sys.thread.EventLoop","new",0xafe12fcd,"sys.thread.EventLoop.new","F:\\program1\\haxe\\std/sys/thread/EventLoop.hx",24,0xface6ce8)
HX_LOCAL_STACK_FRAME(_hx_pos_9efbd1ecb0664138_146_progress,"sys.thread.EventLoop","progress",0xd3ab8d20,"sys.thread.EventLoop.progress","F:\\program1\\haxe\\std/sys/thread/EventLoop.hx",146,0xface6ce8)
HX_LOCAL_STACK_FRAME(_hx_pos_9efbd1ecb0664138_179_loop,"sys.thread.EventLoop","loop",0x33ddc657,"sys.thread.EventLoop.loop","F:\\program1\\haxe\\std/sys/thread/EventLoop.hx",179,0xface6ce8)
namespace sys{
namespace thread{

void EventLoop_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_9efbd1ecb0664138_24_new)
...
bool EventLoop_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::sys::thread::NextEventTime EventLoop_obj::progress(){
            	HX_STACKFRAME(&_hx_pos_9efbd1ecb0664138_146_progress)
...
void EventLoop_obj::loop(){
            	HX_STACKFRAME(&_hx_pos_9efbd1ecb0664138_179_loop)
