...
HX_DEFINE_STACK_FRAME(_hx_pos_f900142cafa9d7e8_7_new,"sys.thread.NoEventLoopException","new",0x6e47ae47,"sys.thread.NoEventLoopException.new","F:\\program1\\haxe\\std/sys/thread/NoEventLoopException.hx",7,0xe5853a84)
namespace sys{
namespace thread{
...
void NoEventLoopException_obj::__construct(::String __o_msg, ::haxe::Exception previous){
            	...
            	HX_STACKFRAME(&_hx_pos_f900142cafa9d7e8_7_new)
