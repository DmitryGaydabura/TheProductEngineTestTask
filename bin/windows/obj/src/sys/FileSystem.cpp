...
HX_LOCAL_STACK_FRAME(_hx_pos_9a6ea708dbbf11b7_31_exists,"sys.FileSystem","exists",0xf55bed9e,"sys.FileSystem.exists","F:\\program1\\haxe\\std/cpp/_std/sys/FileSystem.hx",31,0xb257f40d)
HX_LOCAL_STACK_FRAME(_hx_pos_9a6ea708dbbf11b7_101_readDirectory,"sys.FileSystem","readDirectory",0x0619f8b5,"sys.FileSystem.readDirectory","F:\\program1\\haxe\\std/cpp/_std/sys/FileSystem.hx",101,0xb257f40d)
namespace sys{
...
bool FileSystem_obj::exists(::String path){
            	HX_STACKFRAME(&_hx_pos_9a6ea708dbbf11b7_31_exists)
...
::Array< ::String > FileSystem_obj::readDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_9a6ea708dbbf11b7_101_readDirectory)
