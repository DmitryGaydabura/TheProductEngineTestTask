...
HXLINE(  73)		 ::Dynamic bundle;
HXDLIN(  73)		::String data = HX_("{\"name\":null,\"assets\":\"aoy4:sizei4717y4:typey4:TEXTy9:classNamey21:__ASSET__img_tabs_xmly2:idy14:img%2Ftabs.xmlgh\",\"rootPath\":null,\"version\":2,\"libraryArgs\":[],\"libraryType\":null}",99,dd,f5,d5);
HXDLIN(  73)		 ::lime::utils::AssetManifest manifest = ::lime::utils::AssetManifest_obj::parse(data,::ManifestResources_obj::rootPath);
HXDLIN(  73)		 ::lime::utils::AssetLibrary library = ::lime::utils::AssetLibrary_obj::fromManifest(manifest);
HXLINE(  89)		::lime::utils::Assets_obj::registerLibrary(HX_("default",c1,d8,c3,9b),library);
