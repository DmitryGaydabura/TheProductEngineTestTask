...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("HaxeTheProductEngineTest",f8,4c,a3,64),::ApplicationMain_obj::create_dyn());
...
HXLINE(  38)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("53",5e,2e,00,00));
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("Dmitry Gaydabura",b9,6c,51,f1));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("HaxeTheProductEngineTest",f8,4c,a3,64));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("HaxeTheProductEngineTest",f8,4c,a3,64));
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("HaxeTheProductEngineTest",f8,4c,a3,64));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(2,HX_("width",06,b6,62,ca),635)
            			...
            			->setFixed(7,HX_("height",e7,07,4c,02),445)
            			->setFixed(8,HX_("element",bc,ae,54,06),null())
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("HaxeTheProductEngineTest",f8,4c,a3,64))
