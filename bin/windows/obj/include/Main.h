...
class HXCPP_CLASS_ATTRIBUTES Main_obj : public  ::openfl::display::Sprite_obj
{
	...
	public:
		...
		::Array< ::Dynamic> tabButtons;
		 ::ScrollBar scrollBar;
		 ::openfl::display::Sprite createTabButton(::String label,Float x,Float width, ::TabController controller);
		::Dynamic createTabButton_dyn();

		void resetTabColors();
		::Dynamic resetTabColors_dyn();

		void initScrollBar();
		::Dynamic initScrollBar_dyn();

		void loadTabsFromXml();
		::Dynamic loadTabsFromXml_dyn();
