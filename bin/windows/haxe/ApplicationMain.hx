...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("HaxeTheProductEngineTest", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("HaxeTheProductEngineTest", null, 635, 445);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "53";
		app.meta["company"] = "Dmitry Gaydabura";
		app.meta["file"] = "HaxeTheProductEngineTest";
		app.meta["name"] = "HaxeTheProductEngineTest";
		app.meta["packageName"] = "HaxeTheProductEngineTest";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "HaxeTheProductEngineTest",
			width: 635,
			x: null,
			y: null,
		};
